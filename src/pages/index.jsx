      ...
      <div style={{maxWidth:1080,margin:"0 auto",padding:"0 24px"}}>
        ...
        {pg==="home" && <>
          ...
          <div style={{overflow:"hidden",margin:"0 -24px",padding:"0 24px"}}>
            <div style={{display:"flex",gap:20,padding:"20px 0"}}>{GALLERY.map((s,i)=><img key={i} src={s} alt="" className="gi" loading="lazy" />)}</div>
          </div>
